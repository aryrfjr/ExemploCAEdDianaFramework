...
/**
 *
 * Spring DAO Support implementation for Noticia.
 * Generated by Diana Framework. DO NOT EDIT!!!
 *
 */
public class DAONoticia extends HibernateDaoSupport {
    private final String DOMAIN_CLASS = "br.ufjf.caed.exemplo.model.Noticia";
    ...
    public Object get(final int id) {
        return getHibernateTemplate().get(Noticia.class, new Integer(id));
    }
    public Object get(final long id) {
        return getHibernateTemplate().load(Noticia.class, new Long(id));
    }
    public Object get(final Integer id) {
        return getHibernateTemplate().load(Noticia.class, id);
    }
    public Object get(final Long id) {
        return getHibernateTemplate().load(Noticia.class, id);
    }
    ...
    public void delete(final int id) {
        getHibernateTemplate().delete(getHibernateTemplate().load(Noticia.class, new Integer(id)));
    }
    public void delete(final long id) {
        getHibernateTemplate().delete(getHibernateTemplate().load(Noticia.class, new Long(id)));
    }
    public void delete(final Integer id) {
        getHibernateTemplate().delete(getHibernateTemplate().load(Noticia.class, id));
    }
    public void delete(final Long id) {
        getHibernateTemplate().delete(getHibernateTemplate().load(Noticia.class, id));
    }
