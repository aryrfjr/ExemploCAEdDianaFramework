 ...
 *
 */
public class ColecaoNoticiasTableModel extends AbstractTableModel implements CollectionModel, JTableColumnModel {
    ...
    public ColecaoNoticiasTableModel() {
        // @todo 22012007: Alterar as ordens das colunas no table-model
        columnsOrder = new int[2];
columnsOrder[0] = 0;
columnsOrder[1] = 1;

    }

    public ColecaoNoticiasTableModel(List objects) {
...
case 1: return object.getConteudo();
...
((br.ufjf.caed.exemplo.model.Noticia)obj).getConteudo();
