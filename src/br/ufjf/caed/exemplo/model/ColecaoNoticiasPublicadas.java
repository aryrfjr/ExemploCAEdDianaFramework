 ...
 *  name="ColecaoNoticiasPublicadas"
 * 
 ...
 *
 */
public class ColecaoNoticiasPublicadas extends BusinessObjectsCollection implements BusinessServiceClient {
private BusinessServiceFactory sf;

    public List collection() {
        try {
            ExemploBS bs = (ExemploBS)sf.getService("ExemploBS");
            return bs.getNoticiasPublicadas();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
