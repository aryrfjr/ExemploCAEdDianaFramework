...
/**
 *
 * Abstract list model for br.ufjf.caed.exemplo.model.ColecaoJornalistas objects;
 * Generated by Diana Framework. DO NOT EDIT!!!
 *
 */
public class ColecaoJornalistasListModel extends AbstractListModel implements ComboBoxModel, CollectionModel {
private List objects;

private br.ufjf.caed.exemplo.model.Jornalista selected;

private BusinessObjectsCollection boc;
private JComponent list;
private HashMap<String, String> parameters = new HashMap();

    public ColecaoJornalistasListModel() {
        objects = new ArrayList();
    }

    public void setSelectedItem(int item) {
        if (objects.size() > 0)
            selected = (br.ufjf.caed.exemplo.model.Jornalista)objects.get(item);
    }

    public void setSelectedItem(Object item) {
        int inc = 0;
        for (; inc < objects.size(); inc++) {
            if (item != null && ((br.ufjf.caed.exemplo.model.Jornalista)objects.get(inc)).getNome().equals(item)) {
                selected = (br.ufjf.caed.exemplo.model.Jornalista)objects.get(inc);
                break;
            }
        }
    }
    ...
    public Object getSelectedItem() {
        return selected == null ? "" : ((br.ufjf.caed.exemplo.model.Jornalista)selected).getNome();
    }

    public Object getElementAt(int ind) {
        return selected == null ? "" : ((br.ufjf.caed.exemplo.model.Jornalista)objects.get(ind)).getNome();
    }
    ...
    public void setObjectsCollection(List objects) {
        ...
        if (objects != null && objects.size() > 0) {
            selected = (br.ufjf.caed.exemplo.model.Jornalista)objects.get(0);
            setSelectedIndex(0);
        } else {
            selected = null;
        }
    ...
    public String getSelectedValue() {
        return selected == null ? "" : String.valueOf(((br.ufjf.caed.exemplo.model.Jornalista)selected).getId());
    }
    ...
    public br.ufjf.caed.exemplo.model.Jornalista getSelected() {
        return selected;
    }
    ...
    public void setSelectedObject(Object obj) {
        ...
        while (objs.hasNext()) {
            objcmp = objs.next();
            if (((br.ufjf.caed.exemplo.model.Jornalista)objcmp).getId().equals(obj)) {
                selected = (br.ufjf.caed.exemplo.model.Jornalista)objcmp;
                return;
            }
        }
        if (objects.size() > 0)
    ...
    public void setSelected(br.ufjf.caed.exemplo.model.Jornalista val) {
        this.selected = val;
    }
