...
/**
 *
 * Abstract list model for br.ufjf.caed.exemplo.model.ColecaoNoticiasNaoPublicadas objects;
 * Generated by Diana Framework. DO NOT EDIT!!!
 *
 */
public class ColecaoNoticiasNaoPublicadasListModel extends AbstractListModel implements ComboBoxModel, CollectionModel {
...
private HashMap<String, String> parameters = new HashMap();
    ...
    public ColecaoNoticiasNaoPublicadasListModel() {
    ...
    public String getSelectedValue() {
        return selected == null ? "" : String.valueOf(((br.ufjf.caed.exemplo.model.Noticia)selected).getId());
    }
    ...
    public void setSelectedObject(Object obj) {
        ...
        while (objs.hasNext()) {
            objcmp = objs.next();
            if (((br.ufjf.caed.exemplo.model.Noticia)objcmp).getId().equals(obj)) {
